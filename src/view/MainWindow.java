...
public class MainWindow {
    @FXML
    private ListView<FinalScore> lvScoresPlayer1;
    @FXML
    private ListView<FinalScore> lvScoresPlayer2;
    @FXML
    ...
    public void initialize() {
        ...
        lvScoresPlayer1.itemsProperty().bind(game.getPlayer1().scoresProperty());
        lvScoresPlayer2.itemsProperty().bind(game.getPlayer2().scoresProperty());

        lvScoresPlayer1.setFocusTraversable(false);
        lvScoresPlayer2.setFocusTraversable(false);
